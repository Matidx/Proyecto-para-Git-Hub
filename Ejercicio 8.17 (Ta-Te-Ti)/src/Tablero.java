public class Tablero {
    ...
    public boolean compruebaFila () {
        ...
        if ((this.tablero[0][0] == this.tablero[0][1]) && (this.tablero[0][1] == this.tablero[0][2])) {
            return true;
        }
        if ((this.tablero[1][0] == this.tablero[1][1]) && (this.tablero[1][1] == this.tablero[1][2])) {
            return true;
        }
        if ((this.tablero[2][0] == this.tablero[2][1]) && (this.tablero[2][1] == this.tablero[2][2])) {
            return true;
        }
        return false;
    }
    ...
    public boolean compruebaColumna () {
        if ((this.tablero[0][0] == this.tablero[1][0]) && (this.tablero[1][0] == this.tablero[2][0])) {
            return true;
        }
    ...
    public boolean compruebaDiagonal () {
        ...
        if ((this.tablero[2][0] == this.tablero[1][1]) && (this.tablero[1][1] == this.tablero[0][2])) {
            return true;
        }
        return false;
    }
